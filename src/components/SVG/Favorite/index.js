...
const Favorite = ({ color, size, ...otherProps }) => (
  <svg
    version="1.1"
  ...
  >
    ...
    <g id="Rounded" display="none">
      ...
      <path
        display="inline"
        d="M13.35,20.13c-0.76,0.69-1.93,0.69-2.69-0.01l-0.11-0.1C5.3,15.27,1.87,12.16,2,8.28
    ...
    <g id="Sharp">
      ...
      <path
        d="M12,21.35l-1.45-1.32C5.4,15.36,2,12.28,2,8.5C2,5.42,4.42,3,7.5,3c1.74,0,3.41,0.81,4.5,2.09C13.09,3.81,14.76,3,16.5,3
    ...
    <g id="Duotone" display="none">
      ...
      <g display="inline">
        <path
          opacity="0.3"
          d="M16.5,5c-1.54,0-3.04,0.99-3.56,2.36h-1.87C10.54,5.99,9.04,5,7.5,5C5.5,5,4,6.5,4,8.5
			c0,2.89,3.14,5.74,7.9,10.05l0.1,0.1l0.1-0.1C16.86,14.24,20,11.39,20,8.5C20,6.5,18.5,5,16.5,5z"
        />
        <path
          d="M16.5,3c-1.74,0-3.41,0.81-4.5,2.09C10.91,3.81,9.24,3,7.5,3C4.42,3,2,5.42,2,8.5c0,3.78,3.4,6.86,8.55,11.54L12,21.35
